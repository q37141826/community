...
public class MyPickerView extends View {
    ...
    //显示的默认行数
    private static final int DEFUALT_LINES = 3;
    ...
    private final float MAX_SIZE = 8.0f, MIN_SIZE = 3.0f;
    ...
    public void setShowLines(int showLines) {
        ...
        Log.d(TAG, "setShowLines: lineScale = " + lineScale);
        invalidate();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 按照View的高度计算字体大小  
        mMaxTextSize = (mViewHeight / MAX_SIZE - 5) * lineScale;
//        mMinTextSize = mMaxTextSize / MIN_SIZE;
        mMinTextSize = (mMaxTextSize - 15) * lineScale;
        isInit = true;
        invalidate();
    }
