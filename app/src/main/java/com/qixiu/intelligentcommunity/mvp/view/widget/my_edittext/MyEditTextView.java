package com.qixiu.intelligentcommunity.mvp.view.widget.my_edittext;
...
//        relativeLayout = (RelativeLayout) view.findViewById(R.id.relativelayout_myEdittext);
        ...
        textwatech = new IntelligentTextWatcher(editText.getId(), this);
        ...
        float textSize = array.getDimension(R.styleable.MyEditTextView_my_edittext_text_size, getResources().getDimension(R.dimen.font_size_10));
...
//        int gravity=array.getIndex(R.styleable.MyEditTextView_gravity);
