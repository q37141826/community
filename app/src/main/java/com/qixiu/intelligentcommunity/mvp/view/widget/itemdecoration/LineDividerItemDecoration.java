package com.qixiu.intelligentcommunity.mvp.view.widget.itemdecoration;
...
public class LineDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public LineDividerItemDecoration(Context context, int orientation) {
        ...
        mDivider = context.getResources().getDrawable(R.drawable.shape_line_bg);
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) child
                    .getLayoutParams();
            params.leftMargin = ArshowContextUtil.dp2px(5);
            params.rightMargin = ArshowContextUtil.dp2px(5);
