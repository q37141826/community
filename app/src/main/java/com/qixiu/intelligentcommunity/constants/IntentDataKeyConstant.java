...
public class IntentDataKeyConstant {
    ...
    public static final String HOME_GAME_ACTION = "home_game_action";
    ...
    public static final String FRAGMENT_POSITION_KEY = "fragment_position";
    ...
    public static final String BROADCAST_EVALUATE_COMPLETE_ACTION = "broadcast_evaluate_complete_action";
    ...
    public static final  String  ITEM ="time";
    public static final String BROADCAST_COMMENTS_OK= "broadcast_comments_ok";
    public static final String BROADCAST_DELETE_OK= "broadcast_delete_ok";
    public static final String BROADCAST_CONFIRM_FINISH = "confirm_finish";
    public static final String BROADCAST_MAIN_FINISH= "broadcast_main_finish";
