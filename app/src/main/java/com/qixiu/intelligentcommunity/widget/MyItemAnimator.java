...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    public void endAnimation(RecyclerView.ViewHolder item) {
        ...
        //noinspection PointlessBooleanExpression,ConstantUrlConditions
     ...
     * pending/running, bluetoothCall {@link #dispatchAnimationsFinished()} to notify any
     * listeners.
     */
     ...
     * then DefaultItemAnimator will bluetoothCall {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int)} and
