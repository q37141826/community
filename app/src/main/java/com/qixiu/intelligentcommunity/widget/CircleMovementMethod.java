...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = GlobalApplication.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = GlobalApplication.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
