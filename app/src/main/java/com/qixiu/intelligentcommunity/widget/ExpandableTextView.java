...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setText(CharSequence text) {
        mRelayout = true;
        if (mTv instanceof TimeLineContentTextView) {
            TimeLineContentTextView contentTV = (TimeLineContentTextView) mTv;
            contentTV.setContent(text);
        } else {
            mTv.setText(text);
        }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandText == null)
            mExpandText = getContext().getResources().getString(R.string.ownercircle_open);
        if (mCollapseText == null)
            mCollapseText = getContext().getResources().getString(R.string.ownercircle_close);
        typedArray.recycle();
    ...
    private void setButtonStatus(boolean mCollapsed) {
        if (mCollapsed) {
