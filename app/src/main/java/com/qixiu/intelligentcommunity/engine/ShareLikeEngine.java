...
public class ShareLikeEngine implements OnClickListener, IUiListener {
    ...
    public PopupWindow showSharePopuWindow(Activity activity, final String imageUrl,
        ...
        TextView tv_QQshape = (TextView) contentView.findViewById(R.id.imageView_share_qq);
        TextView tv_weixinshape = (TextView) contentView.findViewById(R.id.imageView_share_weichat);
        TextView tv_friendshape = (TextView) contentView.findViewById(R.id.imageView_share_weichatcore);
        TextView tv_weiboShape = (TextView) contentView.findViewById(R.id.imageView_share_sinna);
        TextView tv_close = (TextView) contentView.findViewById(R.id.tv_close);
        TextView tv_QZON = (TextView) contentView.findViewById(R.id.imageView_share_qzon);
        TextView tv_clipbord = (TextView) contentView.findViewById(R.id.imageView_share_clibord);
