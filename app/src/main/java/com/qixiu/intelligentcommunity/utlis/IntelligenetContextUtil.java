...
public class IntelligenetContextUtil {
    private static Context context = BaseApplication.getApp();
    ...
    public static boolean networkAvailable() {
        switch (IntelligenetContextUtil.networkAvailableState()) {
            case NONE:
                return false;
            default:
                return true;
    ...
    public static String getSandboxPath() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()))
            return SDCARD_PATH + "Android/data/" + BaseApplication.getApp().getPackageName() + File.separator;
        return null;
    }
    ...
    public static void startApp(List<String> packageNames) {
        try {
            ...
            Log.e(IntelligenetContextUtil.class.getSimpleName(), e.toString());
        }
    }
